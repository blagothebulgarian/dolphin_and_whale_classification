# Project notes and thoughts
- I want to make my own convnet but also make a modified and fine tuned model based of off Resnet-50 ot show off transfer learning and then compare the two 
-
# Capstone Project
